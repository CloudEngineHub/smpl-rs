...
from smpl_rs.types import SmplType, Gender, AnimWrap, AngleType, UpAxis, HandType, FollowerType
from smpl_rs.components import SmplParams, Betas, Animation, GlossInterop,\
                                PoseOverride, Follow, Follower
...
if __name__ == "__main__":
    ...
    animation = Animation.from_npz(path_anim, 70.0, wrap_behaviour=AnimWrap.Reverse,
    ...
    viewer.add_resource(Follower(max_strength=30.0, dist_start=0.1, dist_end=1.0,

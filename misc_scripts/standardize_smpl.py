...
path_model_neutral = osp.join(base_dir, '../../models_lockedhead/smplx/SMPLX_NEUTRAL.npz')

assert osp.exists(path_model_male), f"Path to model {path_model_male} does not exist"
assert osp.exists(path_model_female), f"Path to model {path_model_female} does not exist"
assert osp.exists(path_model_neutral), f"Path to model {path_model_neutral} does not exist"
...
standardize_npz(path_model_female, out_model_female, out_model_female_uv, out_model_female_ft)
standardize_npz(path_model_neutral, out_model_neutral, out_model_neutral_uv, out_model_neutral_ft)
